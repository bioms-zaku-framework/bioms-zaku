...
def test_screening_classes():
    ...
    aud = pd.DataFrame([dict(method_id=m, stratum="s", target="t", verdict=v) for m, v in
                        [("A", "SPECIFIC"), ("B", "SPECIFIC"), ("C", "MEASURES_CONTROL"), ("D", "SPECIFIC"), ("E", "INCONCLUSIVE")]])
    ...
    assert out == {"A": "original-specific-useful", "B": "redundant-specific-notuseful", "C": "original-nonspecific-useful",
                   "D": "identity", "E": "inconclusive"}
